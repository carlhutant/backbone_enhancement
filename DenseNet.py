...
def densenet121(model_id: int = 0, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> DenseNet:
    ...
    """
    if 'growth_rate16' in configure.model_mode[model_id]:
        return _densenet("densenet121", 16, (6, 12, 24, 16), 32, pretrained, progress, model_id=model_id, **kwargs)
    return _densenet("densenet121", 32, (6, 12, 24, 16), 64, pretrained, progress, model_id=model_id, **kwargs)
